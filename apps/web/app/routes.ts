...
//
// Layout routes use a parent layout (`routes/_app.tsx`) that requires a
// session and renders the sidebar+topbar shell. Public auth flows
// (signup, login, logout) live at the top level.
//
// Routes that reference auth flows not yet implemented (forgot, reset,
// verify-*, magic) point to placeholder files; the auth UI for those
